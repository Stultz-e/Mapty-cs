...
var TIMEOUT_SEC = 1000;
exports.TIMEOUT_SEC = TIMEOUT_SEC;
var RESULTS_PER_PAGE = 10;
exports.RESULTS_PER_PAGE = RESULTS_PER_PAGE;
var KEY = 'd30e3f37-908f-43c1-8e3d-2e4e3b860004';
exports.KEY = KEY;
...
var RecipeView = /*#__PURE__*/function (_View) {
  ...
  _createClass(RecipeView, [{
    ...
    value: function addHandlerRender(handler) {
      // controlRecipes();
      // multiple event handler for each function
...
},{"./View":"src/js/views/View.js","../../img/icons.svg":"src/img/icons.svg","fracty":"node_modules/fracty/fracty.js"}],"src/js/views/searchView.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(ResultsView, [{
    ...
    function _generateMarkup() {
      ...
      return this._data.map(function (recipe) {
        return _previewView.default.render(recipe, false);
      }).join('');
    }
  }]);
  return ResultsView;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            id = window.location.hash.slice(1); // If no recipe ID is found, return function call at this point
            if (id) {
              _context.next = 4;
              break;
            }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 11:
            _context3.prev = 11;
            _context3.t0 = _context3["catch"](0);
            console.error('custom error' + newRecipe);
...
init();
},{"./model.js":"src/js/model.js","./config":"src/js/config.js","./views/recipeView":"src/js/views/recipeView.js","./views/searchView":"src/js/views/searchView.js","./views/resultsView":"src/js/views/resultsView.js","./views/paginationView":"src/js/views/paginationView.js","./views/bookmarksView":"src/js/views/bookmarksView.js","./views/addRecipeView":"src/js/views/addRecipeView.js","core-js/stable":"node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","regenerator-runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
